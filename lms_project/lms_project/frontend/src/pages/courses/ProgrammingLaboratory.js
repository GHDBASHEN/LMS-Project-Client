...
export default function ProgrammingLaboratory() {
      ...
      <div className="course-header">
        <div className="course-header-content">
          <div className="course-image">
            <img src={course.image || "/Images/co1.jpeg"} alt={course.title} />
          </div>
          ...
          <div className="overview-section">
            ...
            <div className="course-details">
              ...
              <ul className="learning-objectives">
                <li>Master hands-on programming techniques and problem-solving approaches</li>
                <li>Develop proficiency in multiple programming languages and frameworks</li>
                <li>Learn to debug, test, and optimize code effectively</li>
                <li>Understand software development lifecycle and best practices</li>
              ...
              <ul className="requirements">
                ...
                <li>Willingness to practice coding regularly</li>
